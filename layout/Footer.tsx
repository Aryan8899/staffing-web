...
function FooterLink({ href = "#", children }: { href?: string; children: React.ReactNode }) {
  return (
    <li>
      <a href={href} className="flex items-start gap-2 text-gray-300 hover:text-white text-[14px] transition-colors group">
        <ChevronDouble />
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <FooterLink>About Team</FooterLink>
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <FooterLink>Payroll &amp; Compliances</FooterLink>
            <FooterLink>Training &amp; Development</FooterLink>
            <FooterLink>HR Core Services</FooterLink>
            <FooterLink>Resume Building &amp; LinkedIn Profile Optimization</FooterLink>
          </ul>
        </div>
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3 text-gray-300 text-[13.5px] leading-relaxed">
              <svg className="w-4 h-4 text-[#3B6FE8] flex-shrink-0 mt-0.5" viewBox="0 0 24 24" fill="currentColor">
                ...
                <path d="M5.5 3.5h2v3h-2zM5.5 3.5" fill="none" />
                {/* id card icon path */}
