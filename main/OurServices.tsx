...
const services = [
  {
    ...
    description: "Full-cycle hiring support—from requirement analysis, sourcing, screening, and assessment to shortlisting, interview coordination, and onboarding follow-up. Final hiring decisions rest with the client company.",
    image: "https://mspireventures.com/wp-content/uploads/2023/06/erherthrtht.png",
  },
  {
    id: 2,
    title: "Talent Acquisition Support",
    description: "Scalable hiring assistance tailored to business needs, whether filling a single role or scaling up multiple positions.",
    image: "https://mspireventures.com/wp-content/uploads/2023/06/new-2.png",
  },
  {
    id: 3,
    title: "Candidate Sourcing",
    description: "Multi-channel talent discovery via professional networks, job platforms, referrals, and active headhunting to find exact matches.",
  ...
  },
  {
    ...
    description: "Free profile registration for job seekers across industries. Note: Employment is not guaranteed; final selection rests solely with the hiring company.",
